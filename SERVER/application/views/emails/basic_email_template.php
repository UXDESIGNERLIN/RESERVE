...
<table bgcolor="#8a8a8a" class="wrapper header" align="center"><tr><td class="wrapper-inner">
  <table align="center" class="container"><tbody><tr><td>
    <table class="row collapse"><tbody><tr>
      <th class="small-6 large-6 columns first" valign="middle"><table><tr><th>
        <a href="https://myspotbook.com" style="color: #ff942f; text-decoration: none; font-size: 50px;">
          <img src="https://myspotbook.com/email_data/logo_300_300.png" class="logo" width="40">
          MySpotBook.com
        </a>
      </th></tr></table></th>
      <th class="small-6 large-6 columns last" valign="middle"><table><tr><th>
    ...
    <table class="row"><tbody><tr>
      <th class="small-12 large-6 columns first"><table><tr><th>
        ...
        <table class="menu vertical"><tr><td><table><tr>
          <th style="text-align: left;" class="menu-item"><a href="#">Twitter</a></th>
          <th style="text-align: left;" class="menu-item"><a href="#">Facebook</a></th>
          <th style="text-align: left;" class="menu-item"><a href="#">Google +</a></th>
